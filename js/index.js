const content = [
  [
    '"태도가 성과를 만들고, 습관이 나를 만든다." <br><br>함께 일하고 싶은 동료, 소프트웨어 개발자 손보경입니다. <br> 자기개발을 좋아하는 개발자로서 새로운 기술을 습득하고 기존 기술을 향상시키는 것을 즐깁니다. <br><br>개발자로서의 역량 뿐만 아니라 한 사람으로서의 인간성을 지속적으로 발전시키고자 합니다. '
  ],
  [
    "",
